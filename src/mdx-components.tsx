...
export const mdxComponents = {
  ...
  table: (props: ComponentProps<"table">) => (
    <div className="my-6 border border-border rounded-none overflow-hidden">
  ...
  code: ({ children, ...props }: CodeProps) => {
    ...
    return (
      <code
        className="px-1.5 py-0.5 rounded-none bg-muted/60 dark:bg-muted/40 text-sm font-mono text-foreground/90"
        {...props}
      >
        {children}
      </code>
